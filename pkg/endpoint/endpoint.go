...
type ContainerStartFunc func(*Endpoint)
...
func CreationValidation(owner regeneration.Owner, mgr endpointManager, cli k8sClient, epTemplate *models.EndpointChangeRequest) (*Endpoint, pkgLabels.Labels, pkgLabels.Labels, error) {
	ep, err := NewEndpointFromChangeModel(owner, epTemplate)
	if err != nil {
